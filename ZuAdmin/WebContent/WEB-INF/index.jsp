...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">H-ui.admin</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.3</span>
	...
	<ul class="Hui-userbar">
		<li>${adminUser.phoneNum}(<c:if test="${empty adminUser.cityName}">总部</c:if>
		<c:if test="${not empty adminUser.cityName}">${adminUser.cityName}</c:if>)
       </li>
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">${adminUser.name} <i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				
				<li><a href="<%=ctxPath%>/Index?action=loginOut">退出</a></li>
			</ul>
		</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a _href="<%=ctxPath%>/Permission?action=list" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="<%=ctxPath%>/AdminUser?action=list">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-house">
			...
			<dd>
				<ul>
					<li><a _href="<%=ctxPath%>/House?action=list&typeId=11&pageIndex=1" href="javascript:void(0)">短租</a></li>
					<li><a _href="<%=ctxPath%>/House?action=list&typeId=12&pageIndex=1" href="javascript:void(0)">写字楼</a></li>
					<li><a _href="<%=ctxPath%>/House?action=list&typeId=13&pageIndex=1" href="javascript:void(0)">合租</a></li>
					<li><a _href="<%=ctxPath%>/House?action=list&typeId=14&pageIndex=1" href="javascript:void(0)">整租</a></li>
					<li><a _href="<%=ctxPath%>/House?action=houseAppList&pageSize=10&status=新增&currentPageNum=1" href="javascript:void(0)">新增预约管理</a></li>
					<li><a _href="<%=ctxPath%>/House?action=houseAppList&status=跟进中&pageSize=10&currentPageNum=1" href="javascript:void(0)">跟进中预约管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
