...
<script type="text/javascript">
	$(function(){
		...
		$("#kanbuq,#imgVerifyCode").click(function(){
			$("#imgVerifyCode").attr("src","<%=ctxPath%>/Index?action=verifyCode&q="+Math.random());
			...
			$.ajax({
				...
				success:function(result){
					if(result.status=="ok"){
						...
						$("#imgVerifyCode").click();
						layer.msg('登录出错'+result.msg,{icon:6,time:3000});
					}
				},
				error:function(){
					alert("ajax登录失败");
    ...
    <form class="form form-horizontal" id="formLogin" method="post">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="phoneNum" name="phoneNum" type="text" placeholder="手机号：" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
